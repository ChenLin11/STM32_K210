...
fm.register(22,fm.fpioa.GPIO0)#引脚22映射为GPIO0  （编号3,连接PC0）
fm.register(24,fm.fpioa.GPIO1)#引脚24映射为GPIO1  （编号5,连接PC1）
...
names = ['First', 'Second', 'Third', 'Fourth', 'Fifth', 'Sixth', 'Seventh', 'Eighth', 'Ninth' , 'Tenth'] # 人名标签，与上面列表特征值一一对应。
reco = ''
record = []
def save_feature(feat):
    with open('/sd/features.txt','a') as f:#在人脸特征文件中添加feat , 关键字 'a' = "append"
